...
#define CHARACTERISTIC_UUID                                                    \
  "0000FFE1-0000-1000-8000-00805F9B34FB" // xcsoar mandates this
                                         // (BluetoothGattClientPort.java)
...
void setup() {
  xTaskCreatePinnedToCore(TaskPoll, "TaskPoll", 1024, NULL, 1, NULL, 1);
  xTaskCreatePinnedToCore(TaskBLE, "TaskBLE", 10240, NULL, 2, NULL, 1);
}
